...
<head>
    <meta charset="utf-8">
    <title>Talleres DGMakers - Fotogrametría</title>
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <h1 class="display-1 text-white mb-0 animated zoomIn">Fotogrametría</h1>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="text-center mx-auto px-5 mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 100%;">
                <h6 class="section-title bg-white text-center text-primary px-3">
                    Escanear un objeto 3D para posteriormente poder imprimirlo
                </h6>
            </div>

            <div>
                <b>Material recomendable para el curso:</b>
                <ul>
                    <li>Software: Zephyr3D</li>
                    <li>Móvil/ipad para realizar fotografías.</li>
                    <li>Objeto para ser escaneado.</li>
                </ul>
            </div>

            <?php

            $directory="../../../img/Talleres/DGMakers/Fotogrametria/";
