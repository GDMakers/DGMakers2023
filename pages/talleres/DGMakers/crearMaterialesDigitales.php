...
<head>
    <meta charset="utf-8">
    <title>Talleres DGMakers - Crear Materiales Curriculares Digitales</title>
...
<body>
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <h1 class="display-1 text-white mb-0 animated zoomIn">Crear Materiales Curriculares Digitales</h1>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            ...
            $directory="../../../img/Talleres/DGMakers/crearMaterialesCurricularesDigitales/";
