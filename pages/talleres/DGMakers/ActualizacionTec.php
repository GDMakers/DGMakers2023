...
<head>
    <meta charset="utf-8">
    <title>Talleres DGMakers - Actualización Tecnológica</title>
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-4 animated zoomIn">Talleres DGMakers</h4>
                            <h1 class="display-1 text-white mb-0 animated zoomIn">Actualización Tecnológica</h1>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="text-center mx-auto px-5 mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 100%;">
                <h6 class="section-title bg-white text-center text-primary px-3">
                    Creación de imágenes con inteligencia artificial y Book Creator.
                </h6>
            </div>
            <?php

            $directory="../../../img/Talleres/DGMakers/ActualizacionTec/";
            ...
            while (($archivo = $dirint->read()) != false)
            {
                if (strpos($archivo,'jpg') || strpos($archivo,'jpeg') || strpos($archivo,'png')){
                    ...
                    echo'<a href="https://youtu.be/g_Xp8_v-KcE"><img class="imgshadow rounded zoomGallery" style="margin: 1vw; width: 40%;" src='.$image.'></a>';
                }
            }
            $dirint->close();
