...
<head>
    <meta charset="utf-8">
    <title>Talleres 4Inclusion - IES Alcántara</title>
...
<body>
        ...
        <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                    <img class="w-100" src="../../../img/4Inclusion/4Inclusion2024.png" alt="Image">
                    <div class="carousel-caption">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-4 animated zoomIn">Talleres 4Inclusion</h4>
                            <h1 class="display-1 text-white mb-0 animated zoomIn">IES Alcántara</h1>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
        <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 40vw;">
                <h5 class="section-title bg-white text-center text-primary px-3 mb-5">Todo el centro CPEE Eusebio Martínez participa en los talleres DGMakers en el IES Alcántara</h5>
                <h10 class="">Experiencia inolvidable donde estudiantes de secundaria y de educación especial colaboran en diversos talleres de ciencia, robótica, música y deporte.</h10>
            </div>
            <?php

            $directory="../../../img/Talleres/4Inclusion/IESAlcantara/";
