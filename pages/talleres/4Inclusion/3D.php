...
<head>
    <meta charset="utf-8">
    <title>Talleres 4Inclusion - 3D</title>
        ...
        <div class="container">
            <div class="text-center mx-auto px-5 mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 100%;">
                <h6 class="section-title bg-white text-center text-primary px-3">
                    Taller de introducción para el diseño de una pieza básica con <a href="https://www.educaciontrespuntocero.com/noticias/programas-diseno-impresoras-3d/#TinkerCAD">TinkerCAD</a>, convertir con <a href="https://ultimaker.com/software/ultimaker-cura/">CURA</a> e imprimir en 3D.
                </h6>
            </div>
            <?php

            $directory="../../../img/Talleres/4Inclusion/3D/";
