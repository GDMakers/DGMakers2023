...
<head>
    <meta charset="utf-8">
    <title>Talleres 4Inclusion - CPEE Eusebio Martínez</title>
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <h1 class="display-1 text-white mb-0 animated zoomIn">CPEE Eusebio Martínez</h1>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 40vw;">
                <h6 class="section-title bg-white text-center text-primary px-3">Desarrollada en el CPEE Eusebio Martínez y con la participación de la Fundación Integra, AMUVIN, el IES Alcántara y el IES Floridablanca</h6>
            </div>
            <?php

            $directory="../../../img/Talleres/4Inclusion/CPEEEusebioMartinez/";
