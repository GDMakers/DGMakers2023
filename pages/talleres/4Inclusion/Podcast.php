...
<head>
    <meta charset="utf-8">
    <title>Talleres 4Inclusion - Podcast</title>
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <h1 class="display-1 text-white mb-0 animated zoomIn">Podcast</h1>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="text-center mx-auto px-5 mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 100%;">
                <h6 class="section-title bg-white text-center text-primary px-3">
                    Recomendable ordenador, móvil, ipad o tablet y el programa Audacity en un PC para editar vídeo.
                </h6>
            </div>
            <?php

            $directory="../../../img/Talleres/4Inclusion/Podcast/";
            ...
            while (($archivo = $dirint->read()) != false)
            {
                if (strpos($archivo,'jpg') || strpos($archivo,'jpeg') || strpos($archivo,'png')){
                    ...
                    echo'<a href="https://www.youtube.com/watch?v=NmWda8pyQZo"><img class="imgshadow rounded zoomGallery" style="width: 10vw; margin: 1vw; width: 40%;" src='.$image.'></a>';
                }
            }
            $dirint->close();
