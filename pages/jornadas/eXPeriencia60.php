...
<head>
    <meta charset="utf-8">
    <title>Jornadas eXPeriencia6.0</title>
        ...
        <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                    <img class="w-100" src="../../img/jornadas/eXPeriencia60 banner.jpeg" alt="Image">
                    <div class="carousel-caption">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-4 animated zoomIn">Jornadas</h4>
                            <h1 class="display-1 text-white mb-0 animated zoomIn">eXPeriencia6.0.</h1>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <!--div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                <h6 class="section-title bg-white text-center text-primary px-3">eMotion</h6>
            </div-->
            <?php

            $directory="../../img/jornadas/eXPeriencia60/";
            ...
            while (($archivo = $dirint->read()) != false)
            {
                if (strpos($archivo,'jpg') || strpos($archivo,'jpeg')){
                    ...
                    echo'<a href='.$image.'><img class="imgshadow rounded zoomGallery wow fadeIn" data-wow-delay="0.5s" style="width: 10vw; margin: 1vw; width: 40%;" src='.$image.'></a>';
                }
            }
            $dirint->close();
