...
<head>
    <meta charset="utf-8">
    <title>DGMakers Tools - StartUp</title>
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <h1 class="display-1 text-white mb-0 animated zoomIn">StartUp</h1>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                <h6 class="section-title bg-white text-center text-primary px-3 mb-3">Crea una StartrUp</h6>
                <!-- <h1 class="display-6 mb-4">En proyectos y becas</h1> -->
                <p class="fact-item bg-light rounded text-center h-100 p-3">
                    <a href="https://www.youtube.com/watch?v=9tMuGHLPDDM"><img class="img-fluid rounded" src="../../../img/DGMakersTools/startup_crear.png"></a>
                </p>
            </div>
        </div>
    </div>
