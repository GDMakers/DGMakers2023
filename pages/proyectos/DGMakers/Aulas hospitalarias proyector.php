...
<head>
    <meta charset="utf-8">
    <title>Aulas Hospitalarias</title>
...
<body>
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption">  
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-4 animated zoomIn">Aulas Hospitalarias</h4>
                            <h1 class="display-1 text-white mb-0 animated zoomIn">Proyector Interactivo</h1>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            ...
            $directory="../../../img/Aulas_Hospitalarias/proyector/";
