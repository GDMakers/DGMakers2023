        ...
        <div class="row g-4">
          <div class="col-12">
            <div class="p-4 p-md-5 border rounded-3 shadow-sm bg-white">
              ...
              <hr class="my-4">
              <h4 class="h6 text-uppercase text-primary mb-3">StartLab intra e intercentros</h4>
              <div class="d-flex flex-wrap gap-2 mb-4">
                <a href="StartLabCentro01.php" class="btn btn-outline-primary btn-sm"><i class="bi bi-flask me-1"></i> Laboratorio dentro del centro</a>
                <a href="StartLab01_Old.php" class="btn btn-outline-primary btn-sm"><i class="bi bi-flask me-1"></i> Laboratorio intercentros 1</a>
                <a href="StartLab01.php" class="btn btn-outline-primary btn-sm"><i class="bi bi-flask-fill me-1"></i> Laboratorio intercentros 2</a>
              </div>
            </div>
          </div>
        </div>
